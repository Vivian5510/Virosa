...
public class AppHttpStatusConstant {
    ...
    public static final int REQUIRE_PASSWORD = 504;
    public static final int REQUIRE_USERNAME = 505;
    public static final int REQUIRE_EMAIL = 506;

    public static final int LOGIN_ERROR = 507;

    public static final int PARAM_INVALID = 602;
    public static final int PARAM_NOT_NULL = 603;
